...
# installed.
TCL_PREFIX='E:/GenAI/Dissertation project/disser\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/GenAI/Dissertation project/disser\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/GenAI/Dissertation project/disser\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/GenAI/Dissertation project/disser\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/GenAI/Dissertation project/disser\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/GenAI/Dissertation project/disser\Library\lib\tclstub86.lib'
